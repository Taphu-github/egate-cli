...
set_device_and_pass_through_parameters(device_parameters=device_parameters, pass_through_parameters=pass_through_parameters, addr_to="01")
set_default_state_for_gate_mode_and_switch_event(pass_through_parameters=pass_through_parameters,switch_event=switch_event, addr_to="01")
set_event_list_for_open_for_entry_and_close_for_entry(event_list=event_list, addr_to="01")
set_event_list_for_open_for_exit_and_close_for_exit(event_list=event_list, addr_to="01")
set_event_list_for_device_lost_power_and_external_alarm(event_list=event_list, addr_to="01")
set_event_list_for_fire_alarm_and_intrusion_alarm(event_list=event_list, addr_to="01")
set_event_list_for_reverse_alarm_and_tailing_alarm(event_list=event_list, addr_to="01")
set_event_list_for_stayed_alarm_and_reserve(event_list=event_list, addr_to="01")
